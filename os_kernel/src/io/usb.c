...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) ChannelInterrupts {
	union {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) FifoSize {
	union {
		struct __attribute__((packed, aligned(1))) {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) CoreOtgControl {
	union {
		struct __attribute__((packed, aligned(1))) {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) CoreOtgInterrupt {
	union {
		struct __attribute__((packed, aligned(1))) {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) CoreAhb {
	union {
		struct __attribute__((packed, aligned(1))) {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) UsbControl {
	union {
		struct __attribute__((packed, aligned(1))) {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) CoreReset {
	union {
		struct __attribute__((packed, aligned(1))) {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) CoreInterrupts {
	union {
		struct __attribute__((packed, aligned(1))) {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) NonPeriodicFifoStatus {
	union {
		struct __attribute__((packed, aligned(1))) {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) CoreNonPeriodicInfo {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) CoreHardware {
	struct __attribute__((packed, aligned(1))) {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) CorePeriodicInfo {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) HostConfig {
	union {
		struct __attribute__((packed, aligned(1))) {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) HostFrameInterval {
	union {
		struct __attribute__((packed, aligned(1))) {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) HostFrameControl {
	union {
		struct __attribute__((packed, aligned(1))) {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) HostFifoStatus {
	union {
		struct __attribute__((packed, aligned(1))) {
			volatile unsigned SpaceAvailable : 16;					// @0
			volatile unsigned QueueSpaceAvailable : 8;				// @16
...
struct __attribute__((packed, aligned(4))) HostPort {
	union {
		struct __attribute__((packed, aligned(1))) {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) HostChannel {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) PowerReg {
	union {
		struct __attribute__((packed, aligned(1))) {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed, aligned(4))) UsbSendControl {
	union {
		struct __attribute__((packed, aligned(1))) {
...
{--------------------------------------------------------------------------*/
#define DWC_CORE_OTGCONTROL			((volatile struct CoreOtgControl*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x00))
#define DWC_CORE_OTGINTERRUPT		((volatile struct CoreOtgInterrupt*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x04))
#define DWC_CORE_AHB				((volatile struct CoreAhb*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x08))
#define DWC_CORE_CONTROL			((volatile struct UsbControl*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x0C))
#define DWC_CORE_RESET				((volatile struct CoreReset*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x10))
#define DWC_CORE_INTERRUPT			((volatile struct CoreInterrupts*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x14))
#define DWC_CORE_INTERRUPTMASK		((volatile struct CoreInterrupts*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x18))
#define DWC_CORE_RECEIVESIZE		((volatile uint32_t*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x24))
#define DWC_CORE_NONPERIODICFIFO	((volatile struct CoreNonPeriodicInfo*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x28))
#define DWC_CORE_USERID				((volatile uint32_t*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x3C))
#define DWC_CORE_VENDORID			((volatile const uint32_t*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x40))
#define DWC_CORE_HARDWARE			((volatile const struct CoreHardware*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x44))
#define DWC_CORE_PERIODICINFO		((volatile struct CorePeriodicInfo*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x100))

/*--------------------------------------------------------------------------}
{					DWC USB HOST REGISTER POINTERS						    }
{--------------------------------------------------------------------------*/
#define DWC_HOST_CONFIG				((volatile struct HostConfig*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x400))
#define DWC_HOST_FRAMEINTERVAL		((volatile struct HostFrameInterval*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x404))
#define DWC_HOST_FRAMECONTROL		((volatile struct HostFrameControl*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x408))
#define DWC_HOST_FIFOSTATUS			((volatile struct HostFifoStatus*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x410))
#define DWC_HOST_INTERRUPT			((volatile uint32_t*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x414))
#define DWC_HOST_INTERRUPTMASK		((volatile uint32_t*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x418))
#define DWC_HOST_FRAMELIST			((volatile uint32_t*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x41C))
#define DWC_HOST_PORT				((volatile struct HostPort*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x440))
#define DWC_HOST_CHANNEL			((volatile struct HostChannel*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0x500))

/*--------------------------------------------------------------------------}
{					DWC POWER AND CLOCK REGISTER POINTER				    }
{--------------------------------------------------------------------------*/
#define DWC_POWER_AND_CLOCK			((struct PowerReg*)(uintptr_t)(IO_BASE + USB_CORE_OFFSET + 0xE00))
...
{--------------------------------------------------------------------------*/
struct usb_device_descriptor __attribute__((aligned(4))) RootHubDeviceDescriptor = {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed)) RootHubConfig {
	struct usb_configuration_descriptor Configuration;
	struct UsbInterfaceDescriptor Interface;
	struct UsbEndpointDescriptor Endpoint;
};

struct RootHubConfig __attribute__((aligned(4))) root_hub_configuration = {
	.Configuration = {
...
{--------------------------------------------------------------------------*/
struct UsbStringDescriptor __attribute__((aligned(4))) RootHubString0 = {
	.Header = {
		.DescriptorLength = 4,
...
{--------------------------------------------------------------------------*/
struct UsbStringDescriptor __attribute__((aligned(4))) RootHubString1 = {
	.Header = {
...
{--------------------------------------------------------------------------*/
struct UsbStringDescriptor __attribute__((aligned(4))) RootHubString2 = {
	.Header = {
...
{--------------------------------------------------------------------------*/
struct HubDescriptor __attribute__((aligned(4))) RootHubDescriptor = {
	.Header = {
...
RESULT PowerOnUsb(void) {
	mbox[0] = 8*4;
	mbox[1] = 0;
	mbox[2] = MAILBOX_TAG_SET_POWER_STATE;
	mbox[3] = 8;
	mbox[4] = 8;
	mbox[5] = 0x3;    // device = USB
	mbox[6] = 0x1;	 // 1 = on	
...
RESULT HCDReset(void) {
	...
	original_tick = get_system_timer();							// Hold original tickcount
	do {
		if (tick_difference(original_tick, get_system_timer())> 100000) {
...
RESULT HCDTransmitFifoFlush(enum CoreFifoFlush fifo) {
	...
	original_tick = get_system_timer();							// Hold original tick count
	do {
		if (tick_difference(original_tick, get_system_timer())> 100000) {
			return ErrorTimeout;									// Return timeout error
		}
	...
	*DWC_CORE_OTGCONTROL = tempOtgControl;							// Write the Otg register
	...
	if (!DWC_HOST_CONFIG->EnableDmaDescriptor) {
		...
		for (int channel = 0; channel < DWC_CORE_HARDWARE->HostChannelCount; channel++) {
			...
			uint64_t original_tick;
			original_tick = get_system_timer();					// Hold original timertick
			do {
				if (tick_difference(original_tick, get_system_timer()) > 0x100000) {
...
RESULT HCDWaitOnTransmissionResult(uint32_t timeout, uint8_t channel, struct ChannelInterrupts *IntFlags) {
	...
	uint64_t original_tick = get_system_timer();					// Hold original tick count
	do {
		wait_usec(100);
		if (tick_difference(original_tick, get_system_timer()) > timeout) {
...
RESULT HCDChannelTransfer(const struct UsbPipe pipe, const struct UsbPipeControl pipectrl, uint8_t* buffer, uint32_t bufferLength, enum PacketId packetId) 
{
	...
	do {
		...
		if (((uint32_t)(intptr_t)&buffer[offset] & 3) != 0) {
			...
			*(uint32_t*)&DWC_HOST_CHANNEL[pipectrl.Channel].DmaAddr = (uint32_t) &aligned_bufs[pipectrl.Channel];
		}
		else {
			// The buffer is 4 byte aligned so we can just use it 
			// C gets a little bit quirky because I have deferenced using the array of the structure .. help C out 
			*(uint32_t*)&DWC_HOST_CHANNEL[pipectrl.Channel].DmaAddr = (uint32_t) &buffer[offset];
		}
		...
		while (sendCtrl.ActionResendSplit) {						// Decision was made to resend split
			...
			if (sendCtrl.LongerDelay) wait_usec(10000);			// Not yet response slower delay
				else wait_usec(2500);								// Small delay between split resends
		}
								...
								uint32_t* bytesTransferred)			// Value at pointer will be updated with bytes transfered to/from buffer (NULL to ignore)				
{
	...
	if (buffer != NULL) {											// Buffer must be valid for any transfer to occur
		...
		if ((result = HCDChannelTransfer(pipe, intPipeCtrl,
			buffer,	bufferLength, USB_PID_DATA1)) != OK) {		// Send or recieve the data
	...
	if ((result = HCDChannelTransfer(pipe, intPipeCtrl, buffer, 0, USB_PID_DATA1)) != OK)	// Send or recieve the status
	{
								...
								uint32_t length)					// The size of that buffer
{
	...
	if (NoEnglishSupport == false) {								// Yipee we have english support				
		...
		for (i = 0; i < ((Header.DescriptorLength - 2) >> 1)
			&& (i < length - 1); i++) buffer[i] = (uint8_t)(*p++);		// Narrow character from unicode to ascii											
	}
...
RESULT HubPortReset(struct UsbDevice *device, uint8_t port) {
	...
	for (retry = 0; retry < 3; retry++) {
		...
		do {
			wait_usec(20000);
            uint32_t raw32 = portStatus.Raw32;
			if ((result = HCDReadHubPortStatus(device->Pipe0, port + 1, &raw32)) != OK) {
				LOG("HUB: Hub failed to get status (4) for %s.Port%d.\n", UsbGetDescription(device), port + 1);
				return result;
			}
            portStatus.Raw32 = raw32;
			timeout++;
...
RESULT EnumerateHub (struct UsbDevice *device) {
    ...
    uint32_t raw32 = status.Raw32;
	if ((result = HCDReadHubPortStatus(device->Pipe0, 0, &raw32)) != OK) // Gateway node status
	{
	...
	wait_usec(data->Descriptor.PowerGoodDelay * 2000);				// Every hub has a different power stability delay
...
RESULT EnumerateDevice(struct UsbDevice *device, struct UsbDevice* ParentHub, uint8_t PortNum) {
	...
	wait_usec(10000);												// Allows time for address to propagate.
						 ...
						 bool runHeaderCheck)						// Whether to run header check
{
	RESULT result;
	uint32_t transfer;
	struct UsbDescriptorHeader __attribute__((aligned(4)))  header  = { 0 };
	struct UsbPipeControl pipectrl = {
		.Channel = dwc_get_free_channel(),							// Find first free channel

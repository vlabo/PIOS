...
{--------------------------------------------------------------------------*/
struct __attribute__((packed)) UsbDeviceRequest {
	uint8_t Type;													// +0x0
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed)) UsbOtherSpeedConfigurationDescriptor {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed)) UsbStringDescriptor {
	struct UsbDescriptorHeader Header;								// +0x0 Length of this descriptor, +0x1 DEVICE descriptor type (enum DescriptorType)
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed)) HubStatus {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed)) HubStatusChange {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed)) HubFullStatus {
	union {
		struct __attribute__((packed, aligned(1))) {
			union {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed)) HubPortStatus {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed)) HubPortStatusChange {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed)) HubPortFullStatus {
	union {
		struct __attribute__((packed, aligned(1))) {
			union {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed)) UsbPipe {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed)) UsbPipeControl {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed)) UsbParent {
...
{--------------------------------------------------------------------------*/
struct __attribute__((packed)) UsbConfigControl {
